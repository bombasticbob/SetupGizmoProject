...
IMPLEMENT_DYNAMIC(CPathBrowse, CDialog)
...
int CPathBrowse::DoModal(void)
{
  ...
  BROWSEINFO bi;
  bi.hwndOwner = PreModal(); // m_pOwner->GetSafeHwnd();
...
// ** THIS BLOCK OF CODE IS NOT USED, BUT IT IS USEFUL FOR **
// ** FUTURE REFERENCE ON HOW TO GET A PIDL FROM A PATH... **
//
...
//
//    MultiByteToWideChar(CP_ACP, MB_PRECOMPOSED, m_csPath, -1,
//                        lpw1, MAX_PATH);
//
